...
#define g_calloc(n,x) monoeg_calloc_verbose(n,x,__FILE__)
...
#define g_free(x) monoeg_free_verbose(x, __FILE__)
...
#define g_malloc(x) monoeg_malloc_verbose(x, __FILE__)
#define g_malloc0(x) monoeg_malloc0_verbose(x, __FILE__)
#define g_ptr_array_grow monoeg_ptr_array_grow
#define g_realloc(ptr,size) monoeg_realloc_verbose(ptr,size,__FILE__)
#define g_try_malloc(x) monoeg_try_malloc_verbose(x, __FILE__)
#define g_try_realloc(ptr,size) monoeg_try_realloc_verbose(ptr,size,__FILE__)
