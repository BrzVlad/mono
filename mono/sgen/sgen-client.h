 ...
 * return FALSE.
 */
gboolean sgen_client_cardtable_scan_object (GCObject *obj, mword block_obj_size, guint8 *cards, CardTableScanType, gpointer *last_ptr_mod_marked, ScanCopyContext ctx);
