...
struct _SgenMajorCollector {
	...
	void (*scan_card_table) (CardTableScanType scan_type, ScanCopyContext ctx, int worker_index, int worker_count);
...
void sgen_los_scan_card_table (CardTableScanType scan_type, ScanCopyContext ctx, int worker_index, int worker_num);
