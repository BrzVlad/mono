...
void sgen_workers_change_object_ops (SgenObjectOperations *object_ops_nopar, SgenObjectOperations *object_ops_par);
...
gboolean sgen_workers_join (gint32 timeout_ms);
