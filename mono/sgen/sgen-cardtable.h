...
void sgen_cardtable_scan_object (GCObject *obj, mword obj_size, guint8 *cards,
		size_t card_offset, size_t num_cards, ScanCopyContext ctx);
...
void sgen_card_table_preclean_mod_union (guint8 *cards, guint8 *cards_preclean, size_t card_offset, size_t num_cards);
