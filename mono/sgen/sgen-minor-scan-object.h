...
#define SERIAL_SCAN_OBJECT simple_par_no_promotion_nursery_serial_scan_object
#define SERIAL_SCAN_VTYPE simple_par_no_promotion_nursery_serial_scan_vtype
#define SERIAL_SCAN_PTR_FIELD simple_par_no_promotion_nursery_serial_scan_ptr_field
#define SERIAL_DRAIN_GRAY_STACK simple_par_no_promotion_nursery_serial_drain_gray_stack
#else
...
#else
#ifdef SGEN_NURSERY_NO_PROMOTION
#define SERIAL_SCAN_OBJECT simple_no_promotion_nursery_serial_scan_object
#define SERIAL_SCAN_VTYPE simple_no_promotion_nursery_serial_scan_vtype
#define SERIAL_SCAN_PTR_FIELD simple_no_promotion_nursery_serial_scan_ptr_field
#define SERIAL_DRAIN_GRAY_STACK simple_no_promotion_nursery_serial_drain_gray_stack
#else
