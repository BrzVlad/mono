...
major_start_nursery_collection (void)
{
	...
	if (compact_blocks && !sweep_in_progress () && !sweep_blocks_job) {
		SGEN_ASSERT (0, !sgen_concurrent_collection_in_progress (), "We can't change block list if other threads are using it");
